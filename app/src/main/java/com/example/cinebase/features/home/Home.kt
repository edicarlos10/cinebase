...
fun Home(homeViewModel: HomeViewModel?) {
    ...
    Scaffold(
        ...
        content = { paddingValues ->
            Column (
                modifier = Modifier.verticalScroll(rememberScrollState()).padding(paddingValues = paddingValues),
            ) {
                NowPlayingBody(homeViewModel = homeViewModel)
                UpComingBody(homeViewModel = homeViewModel)
            }
